 ...
 */
public class ZonaPeligrosa extends DecoratorViaje {
	/**
	 * Constructor para encapsular iviaje
	 * 
	 * @param iviaje viaje a decorar
	 */
	public ZonaPeligrosa(IViaje iviaje) {
	...
	public double getCosto() {
		return this.getIviaje().getCosto() * (1 + this.getIviaje().getDistancia() * 0.20
	...
	public Object clone() throws CloneNotSupportedException {
		ZonaPeligrosa clon=(ZonaPeligrosa)super.clone(); 
